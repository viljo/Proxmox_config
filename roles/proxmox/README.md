...
This role deploys and configures proxmox on Proxmox VE infrastructure.
...
**Example variables:**
- `proxmox_disable_enterprise_repo`: [Description needed]
- `proxmox_enterprise_repo_files`: [Description needed]
- `proxmox_enable_no_subscription_repo`: [Description needed]
- `proxmox_no_subscription_repo_url`: [Description needed]
- `proxmox_no_subscription_repo_urls`: [Description needed]
