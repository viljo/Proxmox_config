...
This role deploys and configures cosmos on Proxmox VE infrastructure.
...
**Example variables:**
- `cosmos_container_id`: [Description needed]
- `cosmos_hostname`: [Description needed]
- `cosmos_domain`: [Description needed]
- `cosmos_memory`: [Description needed]
- `cosmos_cores`: [Description needed]
