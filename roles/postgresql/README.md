...
This role deploys and configures postgresql on Proxmox VE infrastructure.
...
**Example variables:**
- `postgres_container_id`: [Description needed]
- `postgres_hostname`: [Description needed]
- `postgres_domain`: [Description needed]
- `postgres_memory`: [Description needed]
- `postgres_cores`: [Description needed]
