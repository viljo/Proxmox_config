...
This role deploys and configures loopia_dns on Proxmox VE infrastructure.
...
**Example variables:**
- `loopia_dns_enabled`: [Description needed]
- `loopia_dns_domain`: [Description needed]
- `loopia_dns_records`: [Description needed]
- `loopia_dns_default_ttl`: [Description needed]
- `loopia_dns_interface`: [Description needed]
