...
This role deploys and configures zipline on Proxmox VE infrastructure.
...
**Example variables:**
- `zipline_container_id`: [Description needed]
- `zipline_hostname`: [Description needed]
- `zipline_domain`: [Description needed]
- `zipline_memory`: [Description needed]
- `zipline_cores`: [Description needed]
