...
This role deploys and configures nextcloud on Proxmox VE infrastructure.
...
**Example variables:**
- `nextcloud_container_id`: [Description needed]
- `nextcloud_hostname`: [Description needed]
- `nextcloud_domain`: [Description needed]
- `nextcloud_memory`: [Description needed]
- `nextcloud_cores`: [Description needed]
