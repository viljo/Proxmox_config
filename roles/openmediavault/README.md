...
This role deploys and configures openmediavault on Proxmox VE infrastructure.
...
**Example variables:**
- `openmediavault_container_id`: [Description needed]
- `openmediavault_hostname`: [Description needed]
- `openmediavault_domain`: [Description needed]
- `openmediavault_memory`: [Description needed]
- `openmediavault_cores`: [Description needed]
