...
This role deploys and configures keycloak on Proxmox VE infrastructure.
...
**Example variables:**
- `keycloak_container_id`: [Description needed]
- `keycloak_hostname`: [Description needed]
- `keycloak_domain`: [Description needed]
- `keycloak_memory`: [Description needed]
- `keycloak_cores`: [Description needed]
