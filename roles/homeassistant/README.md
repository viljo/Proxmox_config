...
This role deploys and configures homeassistant on Proxmox VE infrastructure.
...
**Example variables:**
- `homeassistant_container_id`: [Description needed]
- `homeassistant_hostname`: [Description needed]
- `homeassistant_domain`: [Description needed]
- `homeassistant_memory`: [Description needed]
- `homeassistant_cores`: [Description needed]
