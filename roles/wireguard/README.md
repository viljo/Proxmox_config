...
This role deploys and configures wireguard on Proxmox VE infrastructure.
...
**Example variables:**
- `wireguard_container_id`: [Description needed]
- `wireguard_hostname`: [Description needed]
- `wireguard_domain`: [Description needed]
- `wireguard_memory`: [Description needed]
- `wireguard_cores`: [Description needed]
