...
This role deploys and configures wazuh on Proxmox VE infrastructure.
...
**Example variables:**
- `wazuh_container_id`: [Description needed]
- `wazuh_hostname`: [Description needed]
- `wazuh_domain`: [Description needed]
- `wazuh_memory`: [Description needed]
- `wazuh_cores`: [Description needed]
