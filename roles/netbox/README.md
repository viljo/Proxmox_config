...
This role deploys and configures netbox on Proxmox VE infrastructure.
...
**Example variables:**
- `netbox_container_id`: [Description needed]
- `netbox_hostname`: [Description needed]
- `netbox_domain`: [Description needed]
- `netbox_memory`: [Description needed]
- `netbox_cores`: [Description needed]
